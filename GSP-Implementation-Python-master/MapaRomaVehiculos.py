...
datos = pd.read_csv("Roma3.csv", sep=",",decimal=".")
...
color_labels = ["Secuencias 0", "Secuencias 1", "Secuencias 2", "Secuencias 3", "Secuencias 4", "Secuencias 5", "Secuencias 6", "Secuencias 7", "Secuencias 8", "Secuencias 9"]
...
mapa.save("MapaVehiculosRomaLargo3.html")
